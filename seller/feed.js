              ...
              <div class="order-header">
                ...
                <select class="status-select" data-id="${h.order_id}">
                  <option value="pending" ${
                    h.order_status === "pending" ? "selected" : ""
                  }>pending</option>
                  <option value="cooking" ${
                    h.order_status === "cooking" ? "selected" : ""
                  }>cooking</option>
                  <option value="done" ${
                    h.order_status === "done" ? "selected" : ""
                  }>done</option>
                  <option value="cancel" ${
                    h.order_status === "cancel" ? "selected" : ""
                  }>cancel</option>
                </select>
                <br><strong>ลูกค้า:</strong> ${h.customer_name} (${
          h.customer_tel
        })
